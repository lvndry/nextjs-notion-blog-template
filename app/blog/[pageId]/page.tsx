...
export default async function NotionPage({ params }: PageProps) {
  ...
  if (
    ...
    resolvedParams.pageId === "undefined" ||
    !isValidUUID(resolvedParams.pageId)
  ) {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 pt-12 pb-8 sm:pt-16 sm:pb-10 md:pt-24 md:pb-16">
            <div className="max-w-3xl">
              <Link
                href="/"
                className={`inline-flex items-center gap-2 transition-colors min-h-[44px] ${
                  coverUrl
              ...
              <div className="mt-3 sm:mt-4 flex items-center gap-2 sm:gap-3">
                ...
                <h1
                  className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight ${
                    coverUrl ? "text-white" : "text-zinc-900 dark:text-white"
                  }`}
                >
                  {title}
                </h1>
                  ...
                  <a
                    ...
                    className={`${
                      coverUrl
                        ...
                        : "border-zinc-300 bg-white text-zinc-900 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800"
                    } inline-flex items-center justify-center rounded-md border px-4 py-2 text-sm backdrop-blur min-h-[44px]`}
                  >
                    Open in Notion
                  </a>
                </div>
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const pageUrl = `${baseUrl}/blog/${resolvedParams.pageId}`;
  ...
  const ogImage = coverUrl || `${baseUrl}/banner.png`;
