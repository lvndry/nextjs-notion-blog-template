          ...
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:mt-8">
                ...
                <a href="https://nextjs-notion-blog-template-eight.vercel.app" className="inline-flex items-center justify-center rounded-md border border-zinc-300 bg-white px-5 py-3 text-zinc-900 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-white dark:hover:bg-zinc-800 min-h-[44px]">See it in action</a>
              </div>
            </div>
